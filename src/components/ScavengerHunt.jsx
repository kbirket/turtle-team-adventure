...
const huntItems = [
  ...
  return (
    <div className="flex-1 bg-[#3b0764] p-4 flex flex-col justify-between overflow-y-auto h-full text-white text-center">
      ...
      {/* Permission Box */}
      <div className="bg-white/10 border border-white/20 p-3 rounded-2xl mb-3 flex flex-col gap-2 flex-shrink-0">
        <p className="text-xs font-bold text-amber-300">
          Parent Permission: May we feature your child's scavenger hunt photos on the Patterson Health Center Facebook page?
        </p>
          ...
          return (
            ...
            >
              ...
              {isDone ? (
                ...
                <label className="bg-[#e11d48] active:bg-[#be123c] text-white text-xs font-black px-3 py-2 rounded-xl cursor-pointer shadow active:scale-95 transition-all flex-shrink-0">
